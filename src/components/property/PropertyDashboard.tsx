                ...
                <div key={property.id} className="flex items-center justify-between p-3 bg-neutral-800 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-400">{property.city}, {property.country}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-white font-medium">{formatCurrency(property.pricePerNight || 0)}/night</p>
                ...
                <div key={property.id} className="flex items-center justify-between p-3 bg-neutral-800 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge className={`text-xs ${
                        property.status === 'active' ? 'bg-green-500/20 text-green-400 border-green-500/30' :
                        property.status === 'pending_approval' ? 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' :
                        'bg-gray-500/20 text-gray-400 border-gray-500/30'
                      }`}>
                        {property.status}
                      </Badge>
