...
import { JobData, JobType, JobPriority } from '@/services/JobAssignmentService'
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Update job information and settings</p>
            </div>
          </div>
          <Button
            variant="ghost"
                ...
                <Card className="bg-gray-800/50 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500 italic">
                      To change property or staff assignment, please create a new job
                    </p>
                  </CardContent>
                </Card>
              </div>
