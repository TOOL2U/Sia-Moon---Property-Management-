      ...
      <div className="max-w-7xl mx-auto px-6 py-8 lg:px-8">
          ...
          <Card className="group hover:shadow-md transition-all duration-200">
            <CardContent className="p-6">
              ...
              <div className="mt-4 flex items-center text-sm">
                ...
                <span className="text-neutral-600 dark:text-neutral-400 ml-1">from last week</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-md transition-all duration-200">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-150">
                  ...
                  <div className="text-xs text-neutral-500 dark:text-neutral-400 flex-shrink-0">2h ago</div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-150">
                  ...
                  <div className="text-xs text-neutral-500 dark:text-neutral-400 flex-shrink-0">1d ago</div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-3 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-150">
                  ...
                  <div className="text-xs text-neutral-500 dark:text-neutral-400 flex-shrink-0">2d ago</div>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="group hover:shadow-md transition-all duration-200">
          <CardHeader className="pb-6">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Your Properties</CardTitle>
                <CardDescription className="text-neutral-600 dark:text-neutral-400">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group/card border border-neutral-200 dark:border-neutral-800 rounded-lg p-5 hover:shadow-md hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200">
                <div className="aspect-video bg-neutral-100 dark:bg-neutral-800 rounded-lg mb-4 flex items-center justify-center">
                  <Building className="h-8 w-8 text-neutral-400 dark:text-neutral-500" />
                </div>
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Villa Paradise</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">Phuket, Thailand</p>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                    <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">85% occupied</span>
                  </div>
                  <span className="text-sm font-medium text-neutral-900 dark:text-neutral-100">฿18,500/month</span>
                </div>
              </div>
              ...
              <div className="group/card border border-neutral-200 dark:border-neutral-800 rounded-lg p-5 hover:shadow-md hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Sunset Villa</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">Koh Samui, Thailand</p>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                    <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">72% occupied</span>
                  </div>
                  <span className="text-sm font-medium text-neutral-900 dark:text-neutral-100">฿15,200/month</span>
                </div>
              </div>
              ...
              <div className="group/card border border-neutral-200 dark:border-neutral-800 rounded-lg p-5 hover:shadow-md hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Ocean Breeze</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">Krabi, Thailand</p>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-amber-500 rounded-full"></div>
                    <span className="text-sm font-medium text-amber-600 dark:text-amber-400">68% occupied</span>
                  </div>
                  <span className="text-sm font-medium text-neutral-900 dark:text-neutral-100">฿12,800/month</span>
                </div>
              </div>
            </div>
          </CardContent>
