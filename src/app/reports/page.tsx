...
import { generateMockReportData, generateMockMetrics, generateMockChartData } from '@/lib/mockReportData'
...
export default function ReportsPage() {
  ...
  const loadReportData = async () => {
    try {
      ...
      const mockEntries = generateMockReportData(filters)
      const mockMetrics = generateMockMetrics()
      const mockChartData = generateMockChartData(filters.dateRange)
      
      setReportEntries(mockEntries)
      ...
      console.log('✅ Report data loaded:', {
        ...
        metrics: mockMetrics,
        chartPoints: mockChartData.length
      })
