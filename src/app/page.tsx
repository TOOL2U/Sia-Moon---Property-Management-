...
export default function Home() {
  ...
  useEffect(() => {
    console.log('🔍 Landing page auth check:', { loading, user: !!user, profile: !!profile, userEmail: user?.email, profileRole: profile?.role })
    ...
    console.log('✅ User authenticated with profile, redirecting to dashboard...', user.email, profile.role)
